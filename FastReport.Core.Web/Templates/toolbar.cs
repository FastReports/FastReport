...
namespace FastReport.Web
{
    ...
    {
        string template_toolbar(bool renderBody, string saveTxt = "Save", string reloadTxt = "Reload", string preparedTxt = "Prepared report",
        ...
        <div class=""{template_FR}-toolbar-dropdown-content"">" +
            (exports.ShowPreparedReport ? $@"<a target=""_blank"" href=""{template_export_url("fpx")}"">{preparedTxt}</a>" : "")
#if !OPENSOURCE
            + (exports.ShowPdfExport ? $@"<a target=""_blank"" href=""{template_export_url("pdf")}"">{pdfTxt}</a>" : "") +
            (exports.ShowExcel2007Export ? $@"<a target=""_blank"" href=""{template_export_url("xlsx")}"">{excel2007Txt}</a>" : "") +
            (exports.ShowWord2007Export ? $@"<a target=""_blank"" href=""{template_export_url("docx")}"">{word2007Txt}</a>" : "") +
            (exports.ShowPowerPoint2007Export ? $@"<a target=""_blank"" href=""{template_export_url("pptx")}"">{pptxTxt}</a>" : "") +
            (exports.ShowTextExport ? $@"<a target=""_blank"" href=""{template_export_url("txt")}"">{txtTxt}</a>" : "") +
            (exports.ShowRtfExport ? $@"<a target=""_blank"" href=""{template_export_url("rtf")}"">{rtfTxt}</a>" : "") +
            (exports.ShowXpsExport ? $@"<a target=""_blank"" href=""{template_export_url("xps")}"">{xpsTxt}</a>" : "") +
            (exports.ShowOdsExport ? $@"<a target=""_blank"" href=""{template_export_url("ods")}"">{odsTxt}</a>" : "") +
            (exports.ShowOdtExport ? $@"<a target=""_blank"" href=""{template_export_url("odt")}"">{odtTxt}</a>" : "") +
            (exports.ShowXmlExcelExport ? $@"<a target=""_blank"" href=""{template_export_url("xml")}"">{xmlTxt}</a>" : "") +
            (exports.ShowDbfExport ? $@"<a target=""_blank"" href=""{template_export_url("dbf")}"">{dbfTxt}</a>": "") +
            (exports.ShowCsvExport ? $@"<a target=""_blank"" href=""{template_export_url("csv")}"">{csvTxt}</a>" : "") +
            (exports.ShowMhtExport ? $@"<a target=""_blank"" href=""{template_export_url("mht")}"">{mhtTxt}</a>" : "")
#endif
            + "</div></div>"
            ;
        ...
        <div class=""{template_FR}-toolbar-dropdown-content"">
            " +
            (Toolbar.PrintInHtml ? $@"<a target=""_blank"" href=""{template_print_url("html")}"">{printFromBrowserTxt}</a>
            " : "") +
#if !OPENSOURCE
            (Toolbar.PrintInPdf ? $@"<a target=""_blank"" href=""{template_print_url("pdf")}"">{printFromPdf}</a>
        " : "") +
#endif
        $@"</div>
    </div>";
...
{(Toolbar.ShowRefreshButton ? $@"<div class=""{template_FR}-toolbar-item {template_FR}-pointer"" onclick=""{template_FR}.refresh();"" title=""{reloadTxt}"">
...
{((SinglePage || TotalPages < 2) ? "" : $@"
 {(Toolbar.ShowFirstButton ? $@"<div class=""{template_FR}-toolbar-item {template_FR}-toolbar-narrow {(isFirstPage ? $"{template_FR}-toolbar-notbutton {template_FR}-disabled" : $"{template_FR}-pointer")}"" {(isFirstPage ? "" : $@"onclick=""{template_FR}.goto('first');""")} title=""{firstPageTxt}"">
        <img src=""{template_resource_url("angle-double-left.svg", "image/svg+xml")}"">
    </div>" : "")}
   
{(Toolbar.ShowPrevButton ? $@"<div class=""{template_FR}-toolbar-item {template_FR}-toolbar-narrow {(isFirstPage ? $"{template_FR}-toolbar-notbutton {template_FR}-disabled" : $"{template_FR}-pointer")}"" {(isFirstPage ? "" : $@"onclick=""{template_FR}.goto('prev');""")} title=""{previousPageTxt}"">
...
{(Toolbar.ShowNextButton ? $@" <div class=""{template_FR}-toolbar-item {template_FR}-toolbar-narrow {(isLastPage ? $"{template_FR}-toolbar-notbutton {template_FR}-disabled" : $"{template_FR}-pointer")}"" {(isLastPage ? "" : $@"onclick=""{template_FR}.goto('next');""")} title=""{nextPageTxt}"">
        <img src=""{template_resource_url("angle-right.svg", "image/svg+xml")}"">
    </div>" : "")}
   
{(Toolbar.ShowLastButton ? $@"   <div class=""{template_FR}-toolbar-item {template_FR}-toolbar-narrow {(isLastPage ? $"{template_FR}-toolbar-notbutton {template_FR}-disabled" : $"{template_FR}-pointer")}"" {(isLastPage ? "" : $@"onclick=""{template_FR}.goto('last');""")} title=""{lastPageTxt}"">
