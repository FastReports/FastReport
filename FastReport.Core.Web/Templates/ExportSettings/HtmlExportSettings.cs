...
<div class=""modalcontainer modalcontainer--9"" data-target=""html"">
    <div class=""fr-webreport-popup-content-export-parameters"">
        ...
        <div class=""fr-webreport-popup-content-export-parameters-row"">
            ...
            <input name =""PageSelectorInput"" style=""margin-top: 2px;"" onchange=""OnInputClickHTML()""type=""text"" class=""fr-webreport-popup-content-export-parameters-input""pattern=""[0-9,-\s]""placeholder=""2 or 10-20""value="""" >
        </div>" : "")}
    </div>
